...
class PU_ResNet18(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 =ProductUnits2(3, 64, kernel_size=3, stride=1,padding=1)
        self.bn1 = nn.BatchNorm2d(64)
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        
        self.layer1 = self._make_layer(BasicBlockPU, 64, 2, stride=1)
    ...
    def forward(self, x):
        ...
        return out
def PU_ResNet_18():
    return PU_ResNet18(BasicBlock,BasicBlockPU)
